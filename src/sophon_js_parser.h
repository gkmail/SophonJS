typedef enum {
	...
	N_FUNC_DECL,	/* 341 */
	N_STATEMENT,	/* 342 */
	N_STATEMENT_LIST,	/* 343 */
	N_EXPR_STATEMENT,	/* 344 */
	N_IF_STATEMENT,	/* 345 */
	N_FOR_STATEMENT,	/* 346 */
	N_TRY_STATEMENT,	/* 347 */
	N_BLOCK,	/* 348 */
	...
	N_LEFT_EXPR,	/* 352 */
	N_ASSIGN_EXPR,	/* 353 */
	N_ASSIGN_EXPR_NO_IN,	/* 354 */
	N_VAR_DECL_LIST,	/* 355 */
	N_VAR_DECL,	/* 356 */
	N_VAR_DECL_LIST_NO_IN,	/* 357 */
	N_VAR_DECL_NO_IN,	/* 358 */
	N_CASE_BLOCK,	/* 359 */
	N_CASE_CLAUSES,	/* 360 */
	N_CASE_CLAUSE,	/* 361 */
	N_DEFAULT_CLAUSE,	/* 362 */
	N_CATCH,	/* 363 */
	N_FINALLY,	/* 364 */
	N_FORMAL_PARAM_LIST,	/* 365 */
	N_FORMAL_PARAM_LIST_OR_EMPTY,	/* 366 */
	N_ARRAY_LITERAL,	/* 367 */
	N_OBJECT_LITERAL,	/* 368 */
	N_ELISION,	/* 369 */
	N_ELISION_OR_EMPTY,	/* 370 */
	N_ELEMENT_LIST,	/* 371 */
	N_PROP_AND_VALUE_LIST,	/* 372 */
	N_PROP_AND_VALUE_LIST_OR_EMPTY,	/* 373 */
	N_PROP_ASSIGN,	/* 374 */
	N_PROP_NAME,	/* 375 */
	N_ALL_PROP_NAME,	/* 376 */
	N_FUNC_EXPR,	/* 377 */
	N_MEMBER_EXPR,	/* 378 */
	N_ARGUMENTS,	/* 379 */
	N_ARGUMENTS_OR_EMPTY,	/* 380 */
	N_ARGUMENT_LIST,	/* 381 */
	N_ASSIGN_OP,	/* 382 */
	N_MATH_EXPR,	/* 383 */
	N_BASE_EXPR,	/* 384 */
	N_BASE_EXPR_NO_IN,	/* 385 */
	T_END
} ParserTokenType;
typedef enum {
	R_BEGIN,
