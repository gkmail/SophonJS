typedef enum {
	...
	N_FUNC_DECL,	/* 330 */
	N_STATEMENT,	/* 331 */
	N_STATEMENT_LIST,	/* 332 */
	N_EXPR_STATEMENT,	/* 333 */
	N_IF_STATEMENT,	/* 334 */
	N_FOR_STATEMENT,	/* 335 */
	N_TRY_STATEMENT,	/* 336 */
	N_BLOCK,	/* 337 */
	...
	N_LEFT_EXPR,	/* 341 */
	N_ASSIGN_EXPR,	/* 342 */
	N_ASSIGN_EXPR_NO_IN,	/* 343 */
	N_VAR_DECL_LIST,	/* 344 */
	N_VAR_DECL,	/* 345 */
	N_VAR_DECL_LIST_NO_IN,	/* 346 */
	N_VAR_DECL_NO_IN,	/* 347 */
	N_CASE_BLOCK,	/* 348 */
	N_CASE_CLAUSES,	/* 349 */
	N_CASE_CLAUSE,	/* 350 */
	N_DEFAULT_CLAUSE,	/* 351 */
	N_CATCH,	/* 352 */
	N_FINALLY,	/* 353 */
	N_FORMAL_PARAM_LIST,	/* 354 */
	N_FORMAL_PARAM_LIST_OR_EMPTY,	/* 355 */
	N_ARRAY_LITERAL,	/* 356 */
	N_OBJECT_LITERAL,	/* 357 */
	N_ELISION,	/* 358 */
	N_ELISION_OR_EMPTY,	/* 359 */
	N_ELEMENT_LIST,	/* 360 */
	N_PROP_AND_VALUE_LIST,	/* 361 */
	N_PROP_AND_VALUE_LIST_OR_EMPTY,	/* 362 */
	N_PROP_ASSIGN,	/* 363 */
	N_PROP_NAME,	/* 364 */
	N_FUNC_EXPR,	/* 365 */
	N_MEMBER_EXPR,	/* 366 */
	N_ARGUMENTS,	/* 367 */
	N_ARGUMENTS_OR_EMPTY,	/* 368 */
	N_ARGUMENT_LIST,	/* 369 */
	N_ASSIGN_OP,	/* 370 */
	N_MATH_EXPR,	/* 371 */
	N_BASE_EXPR,	/* 372 */
	N_BASE_EXPR_NO_IN,	/* 373 */
	T_END
} ParserTokenType;
typedef enum {
	R_BEGIN,
